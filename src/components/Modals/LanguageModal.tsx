...
const SUPPORTED_LANGUAGES = ["JavaScript", "C++", "Python", "Java"];
...
const LanguageModal: React.FC<LanguageModalProps> = ({ setSettings, settings }) => {
            ...
            <div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
                <div className='flex min-h-screen items-center justify-center px-4'>
                    ...
                    <div
                        ...
                        onClick={() => setSettings({ ...settings, languageModalIsOpen: false })}
                    >
                        ...
                        <div className='px-6 pt-4 pb-6'>
                            <div className='mt-6 flex justify-between first:mt-0'>
                                <div className='w-[340px]'>
                                    <h3 className=' text-base font-medium'>Language Preference</h3>
                                    <h3 className='text-label-3  mt-1.5'>
                                        Choose your preferred language for coding.
                                    </h3>
                                </div>
...
const LanguageListItem: React.FC<LanguageListItemProps> = ({ language, selectedOption, handleLanguageChange }) => {
    return (
        <li className='relative flex h-8 cursor-pointer select-none py-1.5 pl-2 text-label-2 dark:text-dark-label-2 hover:bg-dark-fill-3 rounded-lg'>
            <div
                className={`flex h-5 flex-1 items-center pr-2 ${selectedOption === language ? "font-medium" : ""}`}
            ...
            <span
                className={`text-blue dark:text-dark-blue flex items-center pr-2 ${
                    selectedOption === language ? "visible" : "invisible"
                }`}
            >
                <BsCheckLg />
            </span>
